...
class DB:
    ...
    def retrieve_radar(self, start, end):
        ...
        try:
            ...
            msg = str(e)
            print("retrieve_radar Error: ", msg)
        else:
            return result
    ...
    def calculate_res_avg(self, start, end):
